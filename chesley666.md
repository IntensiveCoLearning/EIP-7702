...
10. 金融方面影响  
- 利好  
    - 账户抽象，降低交易成本，可以实现0gas交易等运营活动，提升用户接受度，吸引用户
    - pectra成功实施，证明了基金会在推动技术更替方面的能力，未来可能推动更多提效变革
    - 提升L2网络扩展性能，降低交易费用
    - 吸引更多eth质押
- 利空  
    - 可能产生安全漏洞，恶意代理合约
    - 小白用户因为误解导致资金损失
    - 基金会借机抛售，超出运营需要的合理范畴
    - L2项目转向其他链发展，或减少对eth的依赖

- 重点观察事件
    - 用户数量变化：cex交易量，链上活跃地址数量，7702相关地址数量
    - 安全事件：因为代理而引起的安全漏洞
    - 基金会：内部变动；eip erc 推进效率；是否超额抛售并且和升级有关联；
    - 生态占比：eth市值占比；L2生态的项目是否转到其他网络；
    - 质押：质押总量和集中度
